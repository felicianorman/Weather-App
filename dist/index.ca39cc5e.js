...
function getWeather(searchText) {
    return (0, _axiosDefault.default).get("https://cors-anywhere.herokuapp.com/https://api.weatherapi.com/v1/current.json?key=4da078cc9068479c9ef140703231903&q=" + searchText + "&lang=sv").then(function(response) {
