...
var hej = document.getElementById("searchWeather");
        ...
        return __generator(this, function(_a) {
            switch(_a.label){
                case 0:
                    e.preventDefault();
                    div.innerHTML = "";
                    searchText = document.getElementById("searchWeather").value;
                    return [
                        4 /*yield*/ ,
                        (0, _api.getWeather)(searchText)
                    ];
                case 1:
                    weather = _a.sent();
                    createHTML(weather);
...
function createHTML(weather) {
    return __awaiter(this, void 0, void 0, function() {
        var weatherWrapper;
        return __generator(this, function(_a) {
            weatherWrapper = document.getElementById("container");
            Promise.all([
                weather
                ...
                for(var i = 0; i < values.length; i++){
                    ...
                    h2.innerHTML = "Just nu \xe4r det ".concat(values[i].current.temp_c, " \xb0C");
...
},{"./services/api":"bDTNA"}],"bDTNA":[function(require,module,exports) {
...
function getWeather(searchText) {
    var weatherAPI = "/.netlify/functions/location?key=4da078cc9068479c9ef140703231903&q=".concat(searchText, "&lang=sv");
    return (0, _axiosDefault.default).get("https://api.weatherapi.com/v1/current.json?key=4da078cc9068479c9ef140703231903&q=" + searchText + "&lang=sv").then(function(response) {
...
var Buffer = require("6489b82497ed8778").Buffer;
"use strict";
/**
...
},{"6489b82497ed8778":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("df095f9f975cb45b");
var ieee754 = require("9d39da8979a2fe55");
...
},{"df095f9f975cb45b":"eIiSV","9d39da8979a2fe55":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
